    ...
    <div class="container">
        <main>
            ...
            @foreach($categories as $category)          
                <img src="{{Storage::url($category->image)}}" class="m-3"  style=" border: 2px solid #aa0000; border-radius: 17px; height:12rem; display: inline-block; !important" alt="...">    
            @endforeach
            <div class="row m-3">
                ...
                <div class="col-md-8 p-2" style = "border:1px solid #808080; border-radius: 10px;">
                    <P class ="h4 text-white text-center" style=" font-family: 'Times New Roman', Times, serif;">RECOMMENDED</p>
                    <hr class="mx-auto" style= "width:75%; color: #aa0000; height: 3px; ">
                    <img src="{{Storage::url('public/files/xCCWSBMZi929D5ZL1RH4Tqoc7luuNjcpJtqbqNex.png')}}" class ="floar-right m-3 mx-auto" style=" border-radius: 20px; height:12rem; "     alt="..."> 
                </div>
            </div>
            <div class="text-center mt-4"  >
                        ...
                        @foreach($products as $product)
                          <div class="col" style="width: 20% !important">
                            <div class="card shadow-sm " style="background-color : #aa0000;border-radius : 25px; ">
                                <img src="{{Storage::url($product->image)}}" alt="" style=" object-fit: contain;border-radius : 25px;">
        ...
        <footer class="py-4 mt-5 text-white" style ="background-color : #202020; border-radius: 10px">
            <div class="row">
                <div class="col-md-7">
                    <div class="container " >
                        <span class="h1" style= "color: #aa0000;">GM <label class="h6 text-white">GAMEHUB MYANMAR</label></span>  <br/>
